# Resuming work on `dev`

Handoff notes for the work branch, `dev` (until 2026-09-25 `chore/resume-build-remove-auth`). The full project context (decisions, security
